...
void Vzad2___024root__trace_chg_0_sub_0(Vzad2___024root* vlSelf, VerilatedFst::Buffer* bufp);

void Vzad2___024root__trace_chg_0(void* voidSelf, VerilatedFst::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vzad2___024root__trace_chg_0\n"); );
    // Init
    ...
    // Body
    Vzad2___024root__trace_chg_0_sub_0((&vlSymsp->TOP), bufp);
}

void Vzad2___024root__trace_chg_0_sub_0(Vzad2___024root* vlSelf, VerilatedFst::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vzad2___024root__trace_chg_0_sub_0\n"); );
    Vzad2__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    ...
    bufp->chgBit(oldp+3,(vlSelfRef.D));
    bufp->chgBit(oldp+4,(vlSelfRef.E));
    bufp->chgBit(oldp+5,(vlSelfRef.Y));
}

void Vzad2___024root__trace_cleanup(void* voidSelf, VerilatedFst* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vzad2___024root__trace_cleanup\n"); );
    // Init
    Vzad2___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vzad2___024root*>(voidSelf);
    Vzad2__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
